...
It's a Tuesday morning in Portland. Sarah, ops manager at a regional specialty bakery, opens an email from Marco. He's her production lead, seven years in. He just accepted an offer at a larger operation up in Seattle. Two weeks notice.

Sarah does the mental inventory. Marco knows that their flour supplier in Spokane runs 12% more expensive than the cheaper option in Boise, but the protein content is 0.3% more consistent and that matters on Monday mornings after a holiday weekend. Marco knows the proofing room thermostat has a specific drift pattern: when overnight readings start landing in two-decimal-place identical sequences, the unit is 6 to 8 weeks from failing. Marco knows that three of their wholesale accounts never put their custom-order specs in writing. They call him directly at 6 a.m., and one of them switches their delivery preference depending on what their pastry chef is making that week.

None of this lives in the SOP binder. None of it is on the company shared drive. In ten business days, it walks out the door.
...
A concrete example. A contract food manufacturer (CMO) running ISO 22000 has a written cleaning protocol that says "clean line between SKU changes." Their senior line operator, fifteen years in, knows that switching from SKU 47 to SKU 89 specifically requires running the allergen swab twice, not once, because residue patterns differ on this specific extruder when it has been running over 12 hours. That second part is not in the procedure. It is in her head. When she retires, your first allergen recall is 18 months away. The FSA, FDA, or USDA does not care that you had a written protocol. They care that the protocol didn't match how the line actually behaved.
...
2. **Vendor intelligence sheet.** Names, response patterns, escalation paths. Include the unspoken rules: "Karen at PackCo doesn't reply to email but answers her cell."
